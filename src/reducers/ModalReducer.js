...
import {
	...
	MODAL_GENERATE_BTC_STAKE_ADDRESS,
	MODAL_TO_BLACKLIST,
	MODAL_TO_WHITELIST,
	MODAL_WHITELIST,
	MODAL_REPLENISH,
...
const DEFAULT_MODAL_FIELDS = {
	...
	[MODAL_GENERATE_BTC_STAKE_ADDRESS]: Map({}),
...
export default createModule({
	...
	initialState: Map({
		...
		[MODAL_GENERATE_BTC_STAKE_ADDRESS]:
			_.cloneDeep(DEFAULT_FIELDS).merge(DEFAULT_MODAL_FIELDS[MODAL_GENERATE_BTC_STAKE_ADDRESS]),
		[MODAL_TO_BLACKLIST]:
